    ...
    if (myfile.is_open())
    {
        while (getline(myfile, line))
        {
            ...
            if (userMap.count(userIdx) > 0)
            {
                ...
                //userRatingArr = userRatings[userIdx];
            }
            else
            {
                userArr = {0, 0, 0};
            ...
            if (movieMap.count(movieIdx) > 0)
            {
                ...
                //movieRatingArr = movieRatings[movieIdx];
            }
            else
            {
                movieArr = {0, 0, 0};
            ...
            //userRatingArr.push_back(rating);
            //movieRatingArr.push_back(rating);

            userMap[userIdx] = newUser;
            movieMap[movieIdx] = newMovie;
            //userRatings[userIdx] = userRatingArr;
            //movieRatings[movieIdx] = movieRatingArr;
