...
LoadData3::LoadData3()
{
    ...
    dates_per_user = new set<int>[n_users];
    ...
    if (myfile.is_open())
    {
        while (getline(myfile, line))
        {
            ...
            dates_per_user[userIdx - 1].insert(date);
...
set<int> *LoadData3::getDatesPerUser()
{
    return dates_per_user;
}
...
int LoadData3::getMinDate()
{
    return minDate;
}

int LoadData3::getMaxDate()
{
    return maxDate;
}
// For use in SVD++
