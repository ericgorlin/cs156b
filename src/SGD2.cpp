...
SGD2::SGD2(int lf, double lambda_val, double lr, double lambda2, double lr2)
{
    ...
    lambda_avg = lambda2;
    learn_rate_avg = lr2;
    outfile = "sgd_results24probeinc.txt";
    outprobe = "sgd_probe24probeinc.txt";
...
int main() {
   ...
   // SGD2 sgd2(30, .008, .005, .001, .001); // .912609    7
    ...
    SGD2 sgd2(300, .012, .005, .001, .001);  // .913362    10   /902195 24    prove .89735
    //SGD2 sgd2(400, .012, .005, .001, .001);  // .90Ŕ653    26       .89687    probe
